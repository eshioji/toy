package eshioji.newsreader.cli;

import eshioji.newsreader.NewsReaderConfiguration;
import eshioji.newsreader.core.Template;
...
public class RenderCommand extends ConfiguredCommand<NewsReaderConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<NewsReaderConfiguration> bootstrap,
                       Namespace namespace,
                       NewsReaderConfiguration configuration) throws Exception {
